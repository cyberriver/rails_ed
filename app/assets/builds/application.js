(() => {
  ...
  // app/javascript/scripts/sorting.js
  document.addEventListener("turbo:load", function() {
    var control2 = document.querySelector(".sort-by-title");
    if (control2) {
      control2.addEventListener("click", sortRowsByTitle);
    }
  });
  ...
  // app/javascript/scripts/check_pass.js
  document.addEventListener("turbo:load", function() {
    var control2 = document.querySelector(".pass-check");
    if (control2) {
      control2.addEventListener("input", passwordCheck);
    }
  });
  ...
  // app/javascript/scripts/form_inline.js
  document.addEventListener("turbo:load", function() {
  ...
  // app/javascript/scripts/progress_bar.js
  document.addEventListener("turbo:load", function() {
  ...
  function showCurrentProgress(control2) {
    var progress = control2.dataset.progress;
    control2.style = "width:" + progress + "%";
  }

  // app/javascript/scripts/timer.js
  document.addEventListener("turbo:load", function() {
  ...
  // app/javascript/scripts/search.js
  document.addEventListener("turbo:load", function() {
